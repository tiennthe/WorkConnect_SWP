        ...
        <div class="row">
          <div class="col-md-6">
            <div class="info-section">
              ...
              <p>
                <strong>Created By:</strong> <c:out value="${createdByName}" />
              </p>
              <p>
                ...
                <c:choose>
                  ...
                  <c:when test="${interview.status == 1}"
                    ><span class="badge bg-warning text-dark"
                      ><i class="fa fa-rotate"></i> Rescheduled</span
                    ></c:when
                  >
                  <c:when test="${interview.status == 2}"
                    ><span class="badge bg-success"
                      ><i class="fa fa-check-circle"></i> Confirmed</span
                    ></c:when
                  >
                  <c:when test="${interview.status == 3}"
                    ><span class="badge bg-danger"
                      ><i class="fa fa-times-circle"></i> Rejected</span
                    ></c:when
                  >
                </c:choose>
              </p>
              ...
              <div class="mt-3">
                ...
                >
                <c:if
                  test="${interview.status != 2 && interview.status != 3 && interview.createdBy != interview.seekerID}"
                >
                  <form
        ...
        <div class="modal-content">
          ...
          >
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-danger" data-loading-button data-loading-text="Rejecting...">
                Confirm Reject
              </button>
            </div>
          </form>
