...
import="model.Job_Posting_Category"%> <%@page import="java.util.List"%>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    ...
    <div class="job-posting-container">
      ...
      <div class="job-posting-content">
        ...
        <% Job_Posting_Category category = (Job_Posting_Category)
        request.getAttribute("category"); if (category != null) { %>
        <div class="job-detail">
          <div>
            <h5>Job Category:</h5>
