    ...
    <div class="page-container d-flex flex-column min-vh-100">
      ...
      <c:if test="${not empty success}">
        <c:choose>
          ...
          <c:when test="${success eq 'rejected'}"><div class="alert alert-success">Interview rejected successfully.</div></c:when>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <c:forEach var="iv" items="${interviews}">
              <tr>
                ...
                <td>
                  ...
                  <c:if test="${iv.status != 2 && iv.status != 3}">
                    ...
                    <!-- Reschedule -->
                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#res-${iv.id}">
                      <i class="fa fa-calendar"></i> Reschedule
                    </button>

                    <!-- Reject -->
                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#rej-${iv.id}">
              ...
              <!-- Reject Modal -->
              <div class="modal fade" id="rej-${iv.id}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
